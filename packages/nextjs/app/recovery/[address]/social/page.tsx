...
export default function SocialRecovery() {
  ...
  }, [recoveryRequest, currentStep, approvedGuardians.length]);
      ...
      <div className="container mx-auto px-4 py-8">
        <div className="max-w-4xl mx-auto">
          ...
          {currentStep === 0 && recoveryType === 'biometric_social' && (
            <Card className="mb-6">
              <CardHeader>
                ...
                <CardDescription>
                  Authenticate to decrypt the second piece of your private key
                </CardDescription>
              </CardHeader>
          ...
          {((recoveryType === 'password_social' && currentStep === 1) ||
            ...
            <Card className="mb-6">
              <CardHeader>
                ...
                <CardDescription>
                  Send recovery requests to your 5 guardians
                </CardDescription>
              </CardHeader>
              <CardContent className="space-y-4">
                ...
                <Button
                  onClick={handleRequestGuardianApproval}
          ...
          {((recoveryType === 'password_social' && currentStep === 2) ||
            (recoveryType === 'biometric_social' && currentStep === 2)) && recoveryRequest && (
            <div className="space-y-6">
              ...
              <Card>
                <CardHeader>
                  ...
                  <CardDescription>
                    Waiting for guardian approvals and security delay
                  </CardDescription>
                </CardHeader>
                <CardContent className="space-y-4">
              ...
              <Card>
                <CardHeader>
                  ...
                  <CardDescription>
                    Track which guardians have approved your recovery
                  </CardDescription>
                </CardHeader>
                <CardContent>
                      ...
                      <div key={guardian.id} className="flex items-center justify-between p-3 border rounded-lg">
                        <div className="flex items-center space-x-3">
                          <div className={`p-2 rounded-full ${
                            guardian.status === 'approved' ? 'bg-green-100' :
                            guardian.status === 'declined' ? 'bg-red-100' :
                            'bg-gray-100'
                          }`}>
                            <UserIcon className={`h-4 w-4 ${
                              guardian.status === 'approved' ? 'text-green-600' :
                              guardian.status === 'declined' ? 'text-red-600' :
                              'text-gray-600'
                            }`} />
                          </div>
                          <div>
                            ...
                            {guardian.approvedAt && (
                              <p className="text-sm text-gray-500">
                                Approved {guardian.approvedAt.toLocaleString()}
                              </p>
                            )}
                          </div>
                        </div>
                        <div className={`px-2 py-1 rounded-full text-xs font-medium ${
                          ...
                          guardian.status === 'declined' ? 'bg-red-100 text-red-800' :
              ...
              <div className="flex justify-between">
                ...
                <Button
                  ...
                  disabled={!recoveryRequest.canFinalize}
                  size="lg"
                >
