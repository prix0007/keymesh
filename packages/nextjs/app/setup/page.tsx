      ...
      <div className="relative z-10">
        <div className="container mx-auto px-4 py-8">
          <div className="max-w-4xl mx-auto">
            ...
            <div className="mb-8">
              {currentStep === 1 && (
                <PasswordStep data={setupData} updateData={updateSetupData} onNext={nextStep} onPrev={prevStep} />
              )}
              {currentStep === 2 && (
                <BiometricStep data={setupData} updateData={updateSetupData} onNext={nextStep} onPrev={prevStep} />
              )}
              {currentStep === 3 && (
                <GuardiansStep data={setupData} updateData={updateSetupData} onNext={nextStep} onPrev={prevStep} />
              )}
              {currentStep === 4 && (
                <ReviewStep data={setupData} walletAddress={address!} onNext={nextStep} onPrev={prevStep} />
              )}
              {currentStep === 5 && (
                <ProcessingStep
                  data={setupData}
              ...
              {currentStep === 6 && <SuccessStep walletAddress={address!} setupData={setupData} />}
            </div>
