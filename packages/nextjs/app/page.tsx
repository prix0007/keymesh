      ...
      <div className="relative z-10">
            ...
            {isConnected && hasSetup ? (
              <>
                ...
                <p className="text-xl text-gray-600 mb-8 max-w-3xl mx-auto">
                  Your wallet recovery is active and secure. Monitor your setup, test recovery methods, and manage your
                  guardians from your dashboard.
                </p>
              ...
              <>
                ...
                <p className="text-xl text-gray-600 mb-8 max-w-3xl mx-auto">
                  Secure social recovery powered by Avail DA. Your keys are protected by trusted friends, biometrics,
                  and cryptography - no single point of failure.
                </p>
                <div className="flex flex-col sm:flex-row gap-4 justify-center">
                  {isConnected ? (
                    <Link href="/setup">
        ...
        <section id="how-it-works" className="container mx-auto px-4 py-20">
          <div className="text-center mb-16">
            <h2 className="text-3xl md:text-4xl font-bold text-gray-900 mb-4">How Keymesh Protects Your Wallet</h2>
          ...
          <div className="grid md:grid-cols-3 gap-8 max-w-5xl mx-auto">
            <Card className="text-center p-6 bg-white/90 backdrop-blur-sm border border-blue-200 shadow-lg">
              ...
              <CardContent>
                <CardDescription className="text-gray-700">
                  Set up a strong password and register your biometric (face/fingerprint). These encrypt two pieces of
                  your key.
                </CardDescription>
              </CardContent>
            </Card>
            ...
            <Card className="text-center p-6 bg-white/90 backdrop-blur-sm border border-blue-200 shadow-lg">
              ...
              <CardContent>
                <CardDescription className="text-gray-700">
                  Select 5 guardians you trust. They&apos;ll help protect the third piece. You need 3 of them to approve
                  recovery.
                </CardDescription>
              </CardContent>
            </Card>
            ...
            <Card className="text-center p-6 bg-white/90 backdrop-blur-sm border border-blue-200 shadow-lg">
              ...
              <CardContent>
                <CardDescription className="text-gray-700">
                  All pieces are stored on Avail DA permanently. No one can access your wallet without your approval.
                </CardDescription>
              </CardContent>
            </Card>
          </div>
        ...
        <section className="container mx-auto px-4 py-20">
          <div className="text-center mb-16">
            <h2 className="text-3xl md:text-4xl font-bold text-gray-900 mb-4">Why Choose Keymesh</h2>
          </div>
          ...
          <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-8">
            <div className="text-center">
              ...
              <p className="text-sm text-gray-600">
                No single point of failure. Your data is distributed across Avail DA.
              </p>
            </div>
            ...
            <div className="text-center">
              ...
              <p className="text-sm text-gray-600">
                Password, biometric, or social recovery. Multiple ways to regain access.
              </p>
            </div>
            ...
            <div className="text-center">
              ...
              <p className="text-sm text-gray-600">
                Auto-transfer to heirs after 2 years of inactivity. Plan for the future.
              </p>
            </div>
            ...
            {[
              {
                ...
                answer:
                  "You can still recover using your biometric + 3 guardian approvals, or wait for the 7-day social recovery period.",
              },
              {
                question: "Who are guardians and what do they do?",
                answer:
                  "Guardians are trusted friends/family who help protect your wallet. They approve recovery requests after verifying your identity through separate channels.",
              },
              {
                question: "Is my key safe?",
                answer:
                  "Yes. Your key is split using Shamir Secret Sharing and encrypted with AES-256. No single party can access your wallet without your permission.",
              },
              {
                question: "How much does it cost?",
                answer:
                  "One-time cost of ~$0.03 to store your encrypted pieces permanently on Avail DA. No monthly fees.",
              },
              {
                question: "What if Avail goes down?",
                answer:
                  "Avail DA is designed for permanent data availability. Even if some nodes go offline, your data remains accessible through the decentralized network.",
              },
            ].map((faq, index) => (
              <Card key={index}>
                <CardHeader>
        ...
        <section className="container mx-auto px-4 py-20 text-center">
          <div className="max-w-2xl mx-auto">
            <h2 className="text-3xl md:text-4xl font-bold text-gray-900 mb-4">Ready to Protect Your Wallet?</h2>
        ...
        <footer className="border-t bg-white">
          <div className="container mx-auto px-4 py-8">
            ...
            <div className="text-center text-sm text-gray-500 mt-4">© 2024 Keymesh. Your keys, woven together.</div>
          </div>
        </footer>
      </div>
    </div>
