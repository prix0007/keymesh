  ...
  return (
    <Card className="max-w-2xl mx-auto">
      <CardHeader className="text-center">
        ...
        <CardDescription>
          Your biometric encrypts the second piece of your private key. This enables instant recovery when combined with
          your password.
        </CardDescription>
      </CardHeader>
      <CardContent className="space-y-6">
            ...
            <div className="flex items-start">
              ...
              <div>
                ...
                <p className="text-sm text-yellow-700 mt-1">
                  Your browser doesn&apos;t support biometric authentication. You can skip this step and still use password +
                  social recovery.
                </p>
              </div>
            </div>
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
              ...
              >
                <CardContent className="p-6 text-center">
                  ...
                  <p className="text-sm text-gray-600">Use your face to authenticate securely</p>
                </CardContent>
              </Card>
        ...
        <div className="flex justify-between pt-4">
          ...
          <div className="flex space-x-2">
            ...
            <Button onClick={registrationComplete ? handleNext : handleSkip} className="min-w-32">
              Continue
